...
public class BluetoothLeService extends Service {
    ...
    @SuppressLint("NewApi") public void WriteValue(String strValue)
    {
    	mNotifyCharacteristic.setValue(strValue.getBytes());
    	mBluetoothGatt.writeCharacteristic(mNotifyCharacteristic);
    }
    
    @SuppressLint("NewApi") public void findService(List<BluetoothGattService> gattServices)
    {
    ...
    @SuppressLint("NewApi") public boolean connect(final String address) {
    	...
    	Toast.makeText(BluetoothLeService.this, address, Toast.LENGTH_SHORT).show();
